...
win_icestorm_url="https://github.com/drayde/toolchain-icestorm/releases/download/${icestorm_ver}/toolchain-icestorm-windows_amd64-${icestorm_ver}.zip"
...
mac_icestorm_url="https://github.com/drayde/toolchain-icestorm/releases/download/${icestorm_ver}/toolchain-icestorm-darwin-${icestorm_ver}.tar.gz"
...
linux_icestorm_url="https://github.com/drayde/toolchain-icestorm/releases/download/${icestorm_ver}/toolchain-icestorm-linux_x86_64-${icestorm_ver}.tar.gz"
